...
public class CurveMainMenuInitiator : MonoBehaviour {
    ...
    void Start() {
        ...
        environment.Add(new CurveMenuItem("Prefabs/Curve/ButtonSelected", "Instructions", "tutorial", "tutorials", auEngine.getSoundForMenu("tutorials"), new Vector3(0, 0, -offset_y), false, true));
        environment.Add(new CurveMenuItem("Prefabs/Curve/ButtonDefault", "New Game", "curveSelectionMenu", "new_game", auEngine.getSoundForMenu("new_game"), new Vector3(0, 0, 0), false));        
        environment.Add(new CurveMenuItem("Prefabs/Curve/ButtonDefault", "Exit", "exitScene", "exit", auEngine.getSoundForMenu("exit"), new Vector3(0, 0, offset_y), false));
