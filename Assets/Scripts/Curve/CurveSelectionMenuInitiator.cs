...
public class CurveSelectionMenuInitiator : MonoBehaviour {
    ...
    void Start() {
        ...
        environment.Add(new CurveMenuItem("Prefabs/Curve/ButtonDefault", "y = sin(x)", "timeSelectionMenu", "5", auEngine.getSoundForMenu("f5"), new Vector3(0, 0, 4 * offset_y), false));
        ...
        environment.Add(new CurveMenuItem("Prefabs/Curve/ButtonDefault", "Back", "mainMenu", "back", auEngine.getSoundForMenu("back"), new Vector3(0, 0, 6 * offset_y), false));
